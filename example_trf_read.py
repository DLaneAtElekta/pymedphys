...
print(f"Monitor units range: {delivery.monitor_units.min():.2f} - {delivery.monitor_units.max():.2f} MU")
print(f"Gantry angles: {delivery.gantry.min():.1f}° - {delivery.gantry.max():.1f}°")
print(f"Collimator angles: {delivery.collimator.min():.1f}° - {delivery.collimator.max():.1f}°")
